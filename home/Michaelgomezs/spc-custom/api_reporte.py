...
def get_user_data():
    ...
    if conn:
        ...
        return jsonify({"error": "Error de conexión a la base de datos en reporte."})
...
def conectar_bd():
    try:
        ...
        print(f"Error de conexión a la base de datos en reporte: {e}")
        return None
...
def guardar_informe_en_bd(id_formulario, informe_data):
    try:
        ...
        if conn:
            ...
            print("Error de conexión a la base de datos en reporte.")
    except Exception as ex:
...
def generar_pdf(resultados):
    ...
    logo_path = "/home/Michaelgomezs/spc-custom/static/logo.png"  # Reemplaza 'logo.png' con el nombre de tu imagen de logo
